...
to be specified as outlined in the vignette [Custom Models](http://www.drizopoulos.com/vignettes/Custom_Models.html),  
...
*Currently, only the log link is allowed.* First, we simulate some data from a 
...
```{r}
par(mar = c(3, 3, 0, 0), mgp = c(1, 0.5, 0), cex.axis = 0.7, cex.lab = 0.8)
y <- DF$y
y[y > 0] <- log(y[y > 0])
