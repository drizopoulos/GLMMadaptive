...
As described in vignette GLMMadaptive basics (`vignette("GLMMadaptive_basics", package = "GLMMadaptive")`), the log-likelihood function behind the mixed models fitted by **GLMMadaptive** contains an intractable integral over the random effects. In addition, the mode of the log-likelhood function cannot be calculated analytically. Therefore, maximum likelihood estimation requires a combination of numerical integration and optimization.
