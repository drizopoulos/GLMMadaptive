...
# Introduction
In the setting of longitudinal data analysis *** the concept of dynamic individualized predictions. These are
predictions that are updated as extra longitudinal information is recorded for a 
subject. 

We start by introducing the notation for our setting. Let $y_i$ denote the $n_i \times 1$ 
...
function) of the zero-inflated negative binomial distribution. Since there this 
